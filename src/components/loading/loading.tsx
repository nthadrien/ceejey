...
export const LoadingBoxes = () => {
    ...
    const content = (
        <aside style={"min-height: 50vh;"} class="container-sm mx-auto d-flex flex-column gap-4 justify-content-center align-items-center ">


            <svg xmlns="http://www.w3.org/2000/svg" width="10%" height="10%" viewBox="0 0 24 24">
                <rect width="10" height="10" x="1" y="1" fill="#d49ed5" rx="1">
                ...
                <rect width="10" height="10" x="1" y="13" fill="#d49ed5" rx="1">
                ...
                <rect width="10" height="10" x="13" y="13" fill="#d49ed5" rx="1">
            ...
            <h6 class="fs-1 text-center text-secondary">( -_-' ) </h6>
